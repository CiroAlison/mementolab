...
// Foto che ritraggono la modella di spalle / senza capo sopra: il brand le vuole
// fuori dalle sezioni pubbliche del sito. Restano nei dati ma non si mostrano.
const FOTO_ESCLUSE = new Set([
  "/gallery/giubbotti-05.jpg",
  "/gallery/giubbotti-07.jpg",
  "/gallery/giubbotti-08.jpg",
  "/gallery/jeans-04.jpg",
  "/gallery/jeans-05.jpg",
...
/** Opere mostrate nel carosello "In evidenza" della home. */
export const showcaseWorks = works.filter((w) => !FOTO_ESCLUSE.has(w.src));
