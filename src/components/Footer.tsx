...
export function Footer() {
  return (
    <footer className="relative mt-24 overflow-hidden bg-ink text-paper">
      {/* spirale decorativa sullo sfondo */}
      <SpiralMark
        className="pointer-events-none absolute -right-16 -top-16 h-72 w-72 text-paper/5 sm:h-96 sm:w-96"
        aria-hidden
      />
      <div className="wrap relative grid gap-12 py-16 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-2 font-sans text-sm text-paper/80 transition-colors hover:text-flame"
          >
        ...
        <div>
          ...
          <ul className="space-y-2.5 font-sans text-sm text-paper/75">
            ...
            <li className="pt-2">
              <Link href="/commissioni" className="text-flame hover:underline">
